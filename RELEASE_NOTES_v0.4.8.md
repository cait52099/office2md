# office2md v0.4.8 Release Notes

Status: final v0.4.8 release.

## Scope

v0.4.8 adds Multi-library Agent Access and Update Review Foundation:
...
- multi-library agent provenance docs;
- docs and tests for review summaries, review reports, and catalog JSON.

## Update Review

`update-library` now includes additive review fields in its result. The optional review report writes Markdown only:
...
Existing single-library commands remain compatible. Multi-library search execution is not implemented in this release.
